...
/**
 * File for GetTaxiWsdlClass to communicate with SOAP service
 * @package GetTaxi
...
/**
 * GetTaxiWsdlClass to communicate with SOAP service
 * 
 * @package GetTaxi
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2016-01-19
 */
class GetTaxiWsdlClass implements \ArrayAccess, \Iterator, \Countable
{
   ...
   * @var string
   */
  const VALUE_WSDL_URL = 'http://82.138.16.126:8888/TaxiPublic/Service.svc?wsdl';
  ...
  /**
   * Constructor
   * @uses GetTaxiWsdlClass::setLastError()
   * @uses GetTaxiWsdlClass::initSoapClient()
   * @uses GetTaxiWsdlClass::initInternArrayToIterate()
   * @uses GetTaxiWsdlClass::_set()
   ...
   * @return GetTaxiWsdlClass|null
   */
  public static function __set_state(array $_array, $_className = __CLASS__)
  {
    if (class_exists($_className)) {
      $object = @new $_className();
      if (is_object($object) && is_subclass_of($object, 'GetTaxiWsdlClass')) {
   ...
   * @uses GetTaxiClassMap::classMap()
   * @uses GetTaxiWsdlClass::getDefaultWsdlOptions()
   * @uses GetTaxiWsdlClass::getSoapClientClassName()
   * @uses GetTaxiWsdlClass::setSoapClient()
  ...
  public function initSoapClient($_wsdlOptions)
  {
    $wsdlOptions = array();
    //
    //$wsdlOptions['classmap'] = GetTaxiClassMap::classMap();
   ...
   * If a class is named as {GetTaxi}SoapClient, then this is the class that will be used.
  ...
  {
    if (class_exists('GetTaxiSoapClient') && is_subclass_of('GetTaxiSoapClient', 'SoapClient'))
      return 'GetTaxiSoapClient';
    else
      return 'SoapClient';
  }
   ...
   * @uses GetTaxiWsdlClass::WSDL_CACHE_WSDL
   * @uses GetTaxiWsdlClass::WSDL_COMPRESSION
   * @uses GetTaxiWsdlClass::WSDL_CONNECTION_TIMEOUT
   * @uses GetTaxiWsdlClass::WSDL_ENCODING
   * @uses GetTaxiWsdlClass::WSDL_EXCEPTIONS
   * @uses GetTaxiWsdlClass::WSDL_FEATURES
   * @uses GetTaxiWsdlClass::WSDL_LOGIN
   * @uses GetTaxiWsdlClass::WSDL_PASSWORD
   * @uses GetTaxiWsdlClass::WSDL_SOAP_VERSION
   * @uses GetTaxiWsdlClass::WSDL_STREAM_CONTEXT
   * @uses GetTaxiWsdlClass::WSDL_TRACE
   * @uses GetTaxiWsdlClass::WSDL_TYPEMAP
   * @uses GetTaxiWsdlClass::WSDL_URL
   * @uses GetTaxiWsdlClass::VALUE_WSDL_URL
   * @uses GetTaxiWsdlClass::WSDL_USER_AGENT
   * @uses GetTaxiWsdlClass::WSDL_PROXY_HOST
   * @uses GetTaxiWsdlClass::WSDL_PROXY_PORT
   * @uses GetTaxiWsdlClass::WSDL_PROXY_LOGIN
   * @uses GetTaxiWsdlClass::WSDL_PROXY_PASSWORD
   * @uses GetTaxiWsdlClass::WSDL_LOCAL_CERT
   * @uses GetTaxiWsdlClass::WSDL_PASSPHRASE
   * @uses GetTaxiWsdlClass::WSDL_AUTHENTICATION
   * @uses GetTaxiWsdlClass::WSDL_SSL_METHOD
   ...
   * @uses GetTaxiWsdlClass::getSoapClient()
   * @uses GetTaxiWsdlClass::getFormatedXml()
   ...
   * @uses GetTaxiWsdlClass::getSoapClient()
   * @uses GetTaxiWsdlClass::convertStringHeadersToArray()
   ...
   * @uses GetTaxiWsdlClass::getInternArrayToIterate()
   * @uses GetTaxiWsdlClass::getInternArrayToIterateIsArray()
   * @return int
   */
   ...
   * @uses GetTaxiWsdlClass::offsetGet()
   * @return mixed
   */
   ...
   * @uses GetTaxiWsdlClass::getInternArrayToIterateOffset()
   * @uses GetTaxiWsdlClass::setInternArrayToIterateOffset()
   * @return int
   */
   ...
   * @uses GetTaxiWsdlClass::getInternArrayToIterateOffset()
   * @uses GetTaxiWsdlClass::offsetExists()
   * @return bool true|false
   */
   ...
   * @see GetTaxiWsdlClass::offsetGet()
   * @uses GetTaxiWsdlClass::offsetGet()
   * @param int $_index
   * @return mixed
   */
   ...
   * @uses GetTaxiWsdlClass::getAttributeName()
   * @uses GetTaxiWsdlClass::__toString()
   * @uses GetTaxiWsdlClass::_set()
   * @uses GetTaxiWsdlClass::_get()
   * @uses GetTaxiWsdlClass::setInternArrayToIterate()
   * @uses GetTaxiWsdlClass::setInternArrayToIterateIsArray()
   * @uses GetTaxiWsdlClass::setInternArrayToIterateOffset()
